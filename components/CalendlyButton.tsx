  ...
  return (
    <>
      ...
      <a href="https://chat.whatsapp.com/FPBo1Vj2P6jG8Siztvlbrf" target="_blank" rel="noopener noreferrer"
        ...
        <span className="hide-mobile">Join Community</span>
      </a>

      {/* Book a Call — bottom RIGHT */}
      <a href="https://calendly.com/bhadreshdani/b2bsalesbuddy-coaching-call" target="_blank" rel="noopener noreferrer"
        style={{position:'fixed',bottom:24,right:24,zIndex:9999,display:'flex',alignItems:'center',gap:8,padding:'10px 16px',background:'#0D1B2A',color:'#fff',borderRadius:40,boxShadow:'0 4px 16px rgba(0,0,0,0.2)',textDecoration:'none',fontSize:12,fontWeight:600}}>
        <span style={{fontSize:16}}>📞</span>
        <span className="hide-mobile">Book Coaching Call</span>
      </a>
    </>
  )
}
